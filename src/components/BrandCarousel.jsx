...
export default function BrandCarousel({ brands, en, subtitle }) {
  ...
  return <section className="brand-showcase" id="brand-collection" aria-label={en?'Our brands':'브랜드 소개'}>
    <div className="renew-container brand-showcase-heading"><div><h2>OUR BRAND</h2><p>{subtitle}</p></div><Link to="/brands" className="brand-more">FIND OUT MORE <span>⟶</span></Link></div>
